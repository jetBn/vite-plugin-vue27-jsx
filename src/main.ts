...
import { vueComponentNormalizer as NORMALIZER_ID} from './utils/componentNormalizer'
import {  vueHotReload as HMR_RUNTIME_ID } from './utils/vueHotReload'
import { isOnlyTemplateChanged } from './hmr'
